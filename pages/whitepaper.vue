  ...
  <div id="terms" class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-12">
        ...
        <div class="row">
          <div class="col-12 col-lg-6 order-2 oder-lg-1">
            <p>
          ...
          <div class="col-12 col-lg-6 order-1 order-lg-2 align-self-center">
            <img src="/jpg/whitepaper/2.jpg" width="100%" />
          </div>
        </div>
        <br />
        <p>
      ...
      <div class="col-12">
        ...
        <p class="text--purple">Creativity</p>
        <p>
        ...
        <p class="text--purple">Transparency</p>
        <p>
        ...
        <p class="text--purple">Professionalism</p>
        <p>
        ...
        <p class="text--purple">Dedication</p>
        <p>
      ...
      <div class="col-12">
        <p class="text--purple text-center">Website</p>
        <p>
      ...
      <div class="col-12">
        ...
        <p class="text-center ">(tokenId + startingIndex) % 8420 → Initial Sequence Index</p>
        <p class="text--purple text-center">IPFS for metadata storage</p>
        <p>
        ...
        <div class="col-12">
          <p class="text--purple text-center">Rewards and Benefits</p>
          <p>
          ...
          <p class="text--purple text-center">ROYALTIES</p>
          <div class="row">
            <div class="col-12 col-lg-6 align-self-center">
              <img src="/jpg/whitepaper/1.jpg" width="100%" />
            </div>
        ...
        <div class="col-12">
          ...
          ></Sectiontitle>
          <p class="text--purple text-center">December 2021</p>
          <ul>
        ...
        <div class="col-12">
          ...
          <p class="text--purple text-center">PHASE I: MINTING</p>
          <ul style="list-style-type: none; padding: 0; margin: 0">
            <li>
              20% - 1 ETH each will be given away to 5 random AFTP holders.
            </li>
            <li>
              30% - Community Wallet established and 5 ETH added. (floor
              sweeping, development and expanding team)
            </li>
            ...
            <li>
              ...
              (we will start buying the floor a couple of days after mint) Time
              four our $500,000 GRAND PRIZE GIVEAWAY!!! FIVE LUCKY HOLDERS will
              be awarded $100,000 in ETH each when the collection is completely
              sold out.
            </li>
          </ul>
          <p class="text--purple text-center">PHASE II: $BOOZE</p>
          <p>
          ...
          <VueSlickCarousel v-bind="settings">
            <div v-for="(img, index) in images" :key="index">
              ...
              <p class="text-center text--purple">{{ img.text }}</p>
            </div>
          </VueSlickCarousel>
        </div>
        <div class="col-12">
